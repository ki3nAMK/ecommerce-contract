...
import { clientNavData, sellerNavData, navData as dashboardNavData } from '../config-nav-dashboard';
...
export type DashboardLayoutProps = {
  ...
  isContainNavbar: boolean
  type?: 'client' | 'seller' | 'admin'
};

export function DashboardLayout({ sx, children, data, isContainNavbar = false, type = 'client' }: DashboardLayoutProps) {
  ...
  return (
    <>
      ...
      <LayoutSection
        ...
        sidebarSection={
          isContainNavbar ? (isNavHorizontal ? null : (
            <NavVertical
              data={type === 'client' ? clientNavData : (type === 'seller' ? sellerNavData : [])}
              isNavMini={isNavMini}
              layoutQuery={layoutQuery}
              cssVars={navColorVars.section}
              onToggleNav={() =>
